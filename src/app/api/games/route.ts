...
const mockGames: Game[] = [
  ...
  },
  {
    id: "lesson-1",
    title: "Yohoho",
    description: "A fun pirate-themed adventure game with exciting gameplay!",
    thumbnail: "/proxy/lessons-img/lesson-1.webp",
    category: "adventure",
    tags: ["pirate", "adventure", "fun"],
  ...
  },
  {
    id: "lesson-2",
    title: "Paperio 2",
    description: "The sequel to the popular territory capture game!",
    thumbnail: "/proxy/lessons-img/lesson-2.webp",
    category: "strategy",
    tags: ["paperio", "territory", "multiplayer"],
  ...
  },
  {
    id: "lesson-3",
    title: "Paperio 3",
    description: "The latest installment in the Paperio series!",
    thumbnail: "/proxy/lessons-img/lesson-3.webp",
    category: "strategy",
    tags: ["paperio", "territory", "multiplayer", "latest"],
  ...
  },
  {
    id: "lesson-69",
    title: "Flappy Bird",
    description: "The classic endless runner game that took the world by storm!",
    thumbnail: "/proxy/lessons-img/lesson-69.webp",
    category: "arcade",
    tags: ["flappy", "bird", "endless", "classic"],
